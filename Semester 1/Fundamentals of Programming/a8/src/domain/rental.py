...
class Rental:
    ...
    def __str__(self):
        return f" ID:{self.__rental_id}; Movie ID:{self.__movie_id}; Client ID:{self.__client_id}; Rented date:3{self.__rented_date}; Due_date:{self.__due_date}; Returned_date:{self.__returned_date}"
