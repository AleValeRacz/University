            ...
            if choice == '1':
                ...
                if option == '1':
                    ...
                    try:
                        ...
                        self._movie_service.update_movie(id, updated_title, updated_description, updated_genre)
                ...
                if option == '1':
                    try:
                        ...
                        self._client_service.add_client(id,name)
                    except (ValueError, RepositoryException) as e:
                        print(e)
                    ...
                    try:
                        ...
                        self._client_service.update_client(id,updated_name)
                    except (ValueError, RepositoryException) as e:
                        print(e)
                ...
                if option == '1':
                    try:
                        ...
                        self._rental_service.rent_movie(id,movie, client, start, end)
                ...
                if option == '1':
                    ...
                    for rental, delay in late_rental:
                        print(f"Rental ID: {rental}, Days_of_delay:{delay}")
                elif option == '4':
                    pass
                else:
                    print("Invalid choice!")
