...
void Repository::addPackage(string recipient, string street, int number, double x, double y, bool status)
{

	this->packages.push_back(Package(recipient, street, number, x, y, status));
